...
export const COURT_REGION_MAP_DATA: CourtRegionMapItem[] = [
    ...
    { keyword: '경산시', court: '대구회생법원', region: 'Others' },
    { keyword: '경주시', court: '대구회생법원', region: 'Others' },
    { keyword: '계룡시', court: '대전회생법원', region: 'Others' },
    { keyword: '고령군', court: '대구회생법원', region: 'Others' },
    ...
    { keyword: '고흥군', court: '광주회생법원', region: 'Others' },
    { keyword: '곡성군', court: '광주회생법원', region: 'Others' },
    { keyword: '공주시', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '광양시', court: '광주회생법원', region: 'Others' },
    { keyword: '광주광역시', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주광역시 동구', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주광역시 서구', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주광역시 남구', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주광역시 북구', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주광역시 광산구', court: '광주회생법원', region: 'Metro' },
    { keyword: '광주시', court: '수원회생법원', region: 'Metro' },
    { keyword: '광진구', court: '서울회생법원', region: 'Seoul' },
    { keyword: '괴산군', court: '청주지방법원', region: 'Others' },
    { keyword: '구례군', court: '광주회생법원', region: 'Others' },
    { keyword: '구로구', court: '서울회생법원', region: 'Seoul' },
    { keyword: '구리시', court: '의정부지방법원', region: 'Overcrowded' },
    { keyword: '구미시', court: '대구회생법원', region: 'Others' },
    { keyword: '군산시', court: '전주지방법원', region: 'Others' },
    { keyword: '군위군', court: '대구회생법원', region: 'Others' },
    { keyword: '군포시', court: '수원회생법원', region: 'Overcrowded' },
    { keyword: '금산군', court: '대전회생법원', region: 'Others' },
    { keyword: '금천구', court: '서울회생법원', region: 'Seoul' },
    { keyword: '김제시', court: '전주지방법원', region: 'Others' },
    { keyword: '김천시', court: '대구회생법원', region: 'Others' },
    { keyword: '김포시', court: '인천지방법원', region: 'Overcrowded' },
    { keyword: '김해시', court: '창원지방법원', region: 'Others' },
    { keyword: '나주시', court: '광주회생법원', region: 'Others' },
    ...
    { keyword: '논산시', court: '대전회생법원', region: 'Others' },
    { keyword: '단양군', court: '청주지방법원', region: 'Others' },
    { keyword: '담양군', court: '광주회생법원', region: 'Others' },
    { keyword: '당진군', court: '대전회생법원', region: 'Others' },
    { keyword: '대구광역시', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 중구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 동구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 서구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 남구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 북구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 수성구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 달서구', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 달성군', court: '대구회생법원', region: 'Metro' },
    { keyword: '대구광역시 군위군', court: '대구회생법원', region: 'Metro' },
    { keyword: '대전광역시', court: '대전회생법원', region: 'Metro' },
    { keyword: '대전광역시 유성구', court: '대전회생법원', region: 'Metro' },
    { keyword: '대전광역시 대덕구', court: '대전회생법원', region: 'Metro' },
    { keyword: '대전광역시 서구', court: '대전회생법원', region: 'Metro' },
    { keyword: '대전광역시 중구', court: '대전회생법원', region: 'Metro' },
    { keyword: '대전광역시 동구', court: '대전회생법원', region: 'Metro' },
    ...
    { keyword: '목포시', court: '광주회생법원', region: 'Others' },
    { keyword: '무안군', court: '광주회생법원', region: 'Others' },
    { keyword: '무주군', court: '전주지방법원', region: 'Others' },
    { keyword: '문경시', court: '대구회생법원', region: 'Others' },
    { keyword: '밀양시', court: '창원지방법원', region: 'Others' },
    { keyword: '보령시', court: '대전회생법원', region: 'Others' },
    { keyword: '보성군', court: '광주회생법원', region: 'Others' },
    { keyword: '보은군', court: '청주지방법원', region: 'Others' },
    { keyword: '봉화군', court: '대구회생법원', region: 'Others' },
    { keyword: '부산광역시', court: '부산회생법원', region: 'Others' },
    { keyword: '부안군', court: '전주지방법원', region: 'Others' },
    { keyword: '부여군', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '상주시', court: '대구회생법원', region: 'Others' },
    { keyword: '서귀포시', court: '제주지방법원', region: 'Others' },
    { keyword: '서대문구', court: '서울회생법원', region: 'Seoul' },
    { keyword: '서산시', court: '대전회생법원', region: 'Others' },
    { keyword: '서천군', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '성주군', court: '대구회생법원', region: 'Others' },
    { keyword: '세종시', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '순천시', court: '광주회생법원', region: 'Others' },
    { keyword: '시흥시', court: '수원회생법원', region: 'Overcrowded' },
    { keyword: '신안군', court: '광주회생법원', region: 'Others' },
    { keyword: '아산시', court: '대전회생법원', region: 'Others' },
    { keyword: '안동시', court: '대구회생법원', region: 'Others' },
    ...
    { keyword: '여수시', court: '광주회생법원', region: 'Others' },
    { keyword: '여주군', court: '수원회생법원', region: 'Others' },
    { keyword: '연기군', court: '대전회생법원', region: 'Others' },
    { keyword: '연천군', court: '의정부지방법원', region: 'Others' },
    { keyword: '영광군', court: '광주회생법원', region: 'Others' },
    { keyword: '영덕군', court: '대구회생법원', region: 'Others' },
    { keyword: '영동군', court: '청주지방법원', region: 'Others' },
    { keyword: '영등포구', court: '서울회생법원', region: 'Seoul' },
    { keyword: '영암군', court: '광주회생법원', region: 'Others' },
    { keyword: '영양군', court: '대구회생법원', region: 'Others' },
    { keyword: '영월군', court: '춘천지방법원', region: 'Others' },
    { keyword: '영주시', court: '대구회생법원', region: 'Others' },
    { keyword: '영천시', court: '대구회생법원', region: 'Others' },
    { keyword: '예산군', court: '대전회생법원', region: 'Others' },
    { keyword: '예천군', court: '대구회생법원', region: 'Others' },
    { keyword: '오산시', court: '수원회생법원', region: 'Others' },
    { keyword: '옥천군', court: '청주지방법원', region: 'Others' },
    { keyword: '완도군', court: '광주회생법원', region: 'Others' },
    ...
    { keyword: '울릉군', court: '대구회생법원', region: 'Others' },
    { keyword: '울산광역시', court: '울산지방법원', region: 'Metro' },
    { keyword: '울진군', court: '대구회생법원', region: 'Others' },
    ...
    { keyword: '의성군', court: '대구회생법원', region: 'Others' },
    ...
    { keyword: '장성군', court: '광주회생법원', region: 'Others' },
    { keyword: '장수군', court: '전주지방법원', region: 'Others' },
    { keyword: '장흥군', court: '광주회생법원', region: 'Others' },
    ...
    { keyword: '진도군', court: '광주회생법원', region: 'Others' },
    ...
    { keyword: '천안시', court: '대전회생법원', region: 'Others' },
    { keyword: '철원군', court: '의정부지방법원', region: 'Others' },
    { keyword: '청도군', court: '대구회생법원', region: 'Others' },
    { keyword: '청송군', court: '대구회생법원', region: 'Others' },
    { keyword: '청양군', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '칠곡군', court: '대구회생법원', region: 'Others' },
    { keyword: '태백시', court: '춘천지방법원', region: 'Others' },
    { keyword: '태안군', court: '대전회생법원', region: 'Others' },
    ...
    { keyword: '포항시', court: '대구회생법원', region: 'Others' },
    ...
    { keyword: '함평군', court: '광주회생법원', region: 'Others' },
    { keyword: '합천군', court: '창원지방법원', region: 'Others' },
    { keyword: '해남군', court: '광주회생법원', region: 'Others' },
    { keyword: '홍성군', court: '대전회생법원', region: 'Others' },
    { keyword: '홍천군', court: '춘천지방법원', region: 'Others' },
    { keyword: '화성시', court: '수원회생법원', region: 'Others' },
    { keyword: '화순군', court: '광주회생법원', region: 'Others' },
...
const generateCourtConfigs = (): Record<string, CourtConfig> => {
    ...
    const courts = [
        '서울회생법원', '의정부지방법원', '인천지방법원', '수원회생법원', 
        '춘천지방법원', '춘천지방법원 강릉지원', '청주지방법원', '부산회생법원', 
        '울산지방법원', '창원지방법원', '전주지방법원', '제주지방법원', 
        '대전회생법원', '대구회생법원', '광주회생법원'
    ];
    
    // 서울/수원/부산/대전/대구/광주 회생법원은 기본적으로 배우자 재산 50% 미반영, 코인/주식 청산가치 제외
    const specializedCourts = ['서울회생법원', '수원회생법원', '부산회생법원', '대전회생법원', '대구회생법원', '광주회생법원'];

    courts.forEach(court => {
        const isSpecialized = specializedCourts.includes(court);
        configs[court] = { 
            description: 
                court === '서울회생법원' ? '전국 가장 선진적 기준, 채무자 친화적' :
                court === '수원회생법원' ? '신설법원, 빠른 처리, 서울과 동일 기준' :
                court === '부산회생법원' ? '신설법원, 업무 과부하 있으나 기준은 서울 동일' :
                court === '대전회생법원' ? '2026년 3월 개원, 서울식 표준화(배우자 재산/투자손실 제외) 진행 중' :
                court === '대구회생법원' ? '2026년 3월 개원, 기존 보수적 실무에서 서울식 준칙 도입 및 완화 전환 중' :
                court === '광주회생법원' ? '2026년 3월 개원, 광주·전남·전북·제주 권역 전담, 상담센터 운영 강화' :
                court === '인천지방법원' ? '가장 빠른 처리(3.3개월), 채무자 친화적' :
                court === '의정부지방법원' ? '전국 가장 느린 처리(~12개월), 회피 권고' :
                court === '춘천지방법원' ? '매우 빠름 (강릉지원은 9.4개월로 편차 큼)' :
                court === '춘천지방법원 강릉지원' ? '처리가 매우 느린 편 (9.4개월), 가능하면 본원 관할 권고' :
                court === '청주지방법원' ? '보통 처리 속도, 기준 보수적' :
                court === '전주지방법원' ? '보통 처리 속도 (6~7.7개월), 광주회생법원 이송 여부 확인 필요' :
                court === '제주지방법원' ? '처리가 느린 편 (6~9.3개월), 광주회생법원 이송 여부 확인 필요' :
                court === '울산지방법원' ? '높은 인가율(81.7%), 부산회생법원 관할 권고' :
                court === '창원지방법원' ? '보통 속도, 부산회생법원 관할 권고' : '',
            includeSpouseProperty: !isSpecialized, 
