      ...
      >
        ...
        <div className="relative p-5 bg-[#0F2440] text-white">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/15 rounded-xl flex items-center justify-center text-xl backdrop-blur-sm shrink-0">
        ...
        {/* Body */}
        <div className="p-5 space-y-4 overflow-y-auto text-left flex-1">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 flex items-center gap-2.5">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 bg-[#1E3A5F] hover:bg-[#162D4A] text-white rounded-xl text-xs font-bold transition-all active:scale-[0.98] flex items-center justify-center gap-1.5 whitespace-nowrap"
          >
            채무 체크 시작하기
