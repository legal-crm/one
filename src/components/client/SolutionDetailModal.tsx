...
const solutions: Record<SolutionType, SolutionData> = {
  rehab: {
    title: '개인회생',
    subtitle: '매달 소득이 있는 분들이 법원을 통해 채무를 조정할 수 있는 제도',
    badge: '제도 일반정보',
    description: '수입이 있는 직장인이나 자영업자가 최소한의 생계비를 빼고 남은 돈을 3~5년 동안 성실히 갚아 나가면, 법원에서 법원이 인가한 변제계획에 따라 채무를 조정할 수 있는 법원 절차입니다. 이용 가능 여부와 결과는 개인 상황에 따라 달라집니다. 신청서가 접수되는 즉시 법원의 금지명령을 통해 빚 독촉이나 월급 압류에서 안전하게 보호받을 수 있습니다.',
    ...
    timeline: [
      { title: '전문가와 꼼꼼한 서류 준비', desc: '필요한 서류를 준비하고 상환 계획안을 작성합니다. (2~4주)' },
      { title: '법원에 신청서 접수', desc: '서류를 제출하고 사건 번호를 받습니다.' },
      { title: '빚 독촉 및 압류 금지 발령', desc: '법원에 금지명령을 신청하면 독촉과 강제집행에 대한 중지 결정을 받을 수 있습니다.' },
      { title: '개시 결정 (심사 통과)', desc: '법원에서 매달 갚아 나갈 변제금을 최종 확인합니다.' },
      { title: '인가 결정 (최종 승인)', desc: '계획대로 상환을 시작할 수 있게 법원이 확정합니다.' },
      { title: '변제 완료 및 남은 빚 탕감', desc: '변제계획에 따라 성실히 상환을 완료하면 남은 채무에 대해 면책을 받을 수 있습니다.' },
    ],
    pros: [
