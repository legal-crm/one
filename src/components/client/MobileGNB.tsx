...
export default function MobileGNB({ activeTab, onSetActiveTab, onRequestConsult, onStartDiagnosis }: MobileGNBProps) {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-200 dark:border-slate-800 flex items-center justify-around py-3.5 pb-safe-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
      {/* 홈 */}
      <button
      ...
      >
        ...
        <span className="text-[13px] tracking-tight relative z-10">홈</span>
      </button>
      ...
      >
        ...
        <span className="text-[13px] tracking-tight">채무관리 시작</span>
      </button>
      ...
      >
        ...
        <span className="text-[13px] tracking-tight relative z-10">무료 전담배정</span>
      </button>
      ...
      >
        ...
        <span className="text-[13px] tracking-tight relative z-10">내 관리방</span>
