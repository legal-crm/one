            ...
            <div className="w-full max-w-md mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <span className="text-[10px] text-slate-500 block">보안 진단 리포트 뷰어</span>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden rounded-3xl bg-slate-900/90 border border-slate-800 p-6 shadow-2xl space-y-6">
                    ...
                    <div className="relative flex justify-between items-start">
                        <div>
                            <span className="text-[10px] uppercase text-[#7264FF] font-bold tracking-widest block mb-1">CONFIDENTIAL</span>
                    ...
                    <div className="grid grid-cols-2 gap-3 bg-slate-950/60 p-4 rounded-2xl border border-slate-800/80">
                        ...
                        <div className="space-y-0.5">
                            <span className="text-[10px] text-slate-500">총 채무 절감액</span>
                        ...
                        <div className="col-span-2 border-t border-slate-800/50 pt-2.5 mt-1 space-y-0.5">
                            <span className="text-[10px] text-slate-500">예상 월 변제금 ({result.repaymentMonths}개월)</span>
                            <div className="text-lg font-black text-white">
                                {formatCurrency(result.monthlyPayment)} <span className="text-xs text-slate-400 font-normal">/ 월</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3.5 text-xs text-slate-300">
                        ...
                        <div className="flex justify-between items-center py-1">
                            <span className="text-slate-500">월 실수령액 소득</span>
                    ...
                    {(hasSpeculative || hasGambling) && (
                        <div className="p-3.5 bg-amber-500/5 border border-amber-500/10 rounded-2xl space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[10px] text-slate-400 bg-slate-950/40 p-2 rounded-xl">
                                <div>
                    ...
                    {result.aiAdvice && result.aiAdvice.length > 0 && (
                        <div className="p-4 bg-slate-950/40 rounded-2xl space-y-2.5 border border-slate-800/60">
                            <span className="text-[10px] text-slate-500 font-bold block">변호사 검토 의견 가이드라인</span>
