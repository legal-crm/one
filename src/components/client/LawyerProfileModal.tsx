        ...
        <div className="p-5 sm:p-7 space-y-6 max-h-[60vh] overflow-y-auto">
          ...
          {activeTab === 'home' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              {/* 기본 노출 상품 (무료 변호사 회원) — 첨부파일 스타일 */}
              <div className="space-y-3">
                <h3 className="font-bold text-base text-slate-900 flex items-center gap-2">
                  <Paperclip className="w-4 h-4 text-amber-500" />
                  기본 노출 상품 안내
                  <span className="bg-emerald-50 border border-emerald-200 text-emerald-600 text-[10px] font-bold px-2 py-0.5 rounded-full">무료 회원 기본 제공</span>
                </h3>
                <p className="text-[13px] text-slate-500 font-medium leading-relaxed -mt-1">
                  무료 변호사 회원 가입 시 기본으로 제공되는 상품입니다. 아래 항목들이 의뢰인에게 자동 노출됩니다.
                </p>
                  ...
                  {[
                    {
                      ...
                      fileType: 'SERVICE',
                      fileSize: '무제한',
                      desc: '의뢰인이 작성한 상담 요청서를 실시간으로 수신하고 확인할 수 있습니다.',
                      icon: FileText,
                      color: 'text-blue-500',
                      bgColor: 'bg-blue-50',
                    ...
                    {
                      fileName: '채무 진단 리포트 열람',
                      fileType: 'REPORT',
                      fileSize: '자동 생성',
                      desc: '의뢰인의 자가진단 결과 리포트를 변호사 대시보드에서 바로 열람할 수 있습니다.',
                      icon: Eye,
                    ...
                    },
                    {
                      ...
                      fileType: 'CHAT',
                      fileSize: '기본 제공',
                      desc: '의뢰인과 1:1 비밀 채팅을 통해 상담을 진행할 수 있습니다.',
                      icon: MessageSquare,
                    ...
                    },
                    {
                      ...
                      fileType: 'PROFILE',
                      fileSize: '상시 노출',
                      desc: '전담 변호사 찾기 목록에 프로필이 기본 노출되어 의뢰인이 검색·열람할 수 있습니다.',
                      icon: Users,
                    ...
                    <div key={item.fileName} className={`${item.bgColor} border ${item.borderColor} rounded-xl p-3.5 flex items-start gap-3.5 hover:shadow-sm transition-all group/file`}>
                      <div className={`w-10 h-10 rounded-lg bg-white border ${item.borderColor} flex items-center justify-center shrink-0 group-hover/file:scale-105 transition-transform`}>
                        <item.icon className={`w-5 h-5 ${item.color}`} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span className="font-bold text-sm text-slate-900 truncate">{item.fileName}</span>
                          <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${item.badgeColor}`}>{item.fileType}</span>
                        </div>
                        <p className="text-[12px] text-slate-500 leading-relaxed mt-0.5 font-medium">{item.desc}</p>
                ...
                <div className="bg-slate-50 border border-slate-100 rounded-xl p-3.5 flex items-start gap-2.5">
                  ...
                  <p className="text-[12px] text-slate-500 leading-relaxed font-medium">
                    위 상품은 변호사 회원 가입 시 자동으로 활성화됩니다. 상단 노출, 지역 노출 등 추가 광고 상품은 별도 문의를 통해 이용하실 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
