...
export const SummaryAndUrgentNoticeDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  ...
  return (
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[13px] leading-relaxed border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 print:max-w-none">
      ...
      <table className="w-full border-collapse border border-black mb-6 text-center text-[12px]">
        <tbody>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold w-1/4">○ 월평균수입</td>
            <td className="border border-black p-2 w-1/4 text-right pr-4">{repaymentSummary.monthlyNetIncome.toLocaleString()}원</td>
            <td className="border border-black bg-slate-100 p-2 font-semibold w-1/4">○ 가구원수(본인포함)</td>
            <td className="border border-black p-2 w-1/4">{repaymentSummary.householdSize}인 가구</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 기준중위소득 조정금액</td>
            <td className="border border-black p-2 text-right pr-4">{repaymentSummary.monthlyLivingCost.toLocaleString()}원</td>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 기준중위소득 조정비율</td>
            <td className="border border-black p-2">{repaymentSummary.medianIncomeRatio}%</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 월가용소득</td>
            <td colSpan={3} className="border border-black p-2 text-left pl-4 font-bold text-blue-900">
              {repaymentSummary.monthlyDisposableIncome.toLocaleString()}원
            </td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 최초 입금일자</td>
            <td colSpan={3} className="border border-black p-2 text-left pl-4">{data.court.firstRepaymentDate}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 변제기간</td>
            <td colSpan={3} className="border border-black p-2 text-left pl-4">{repaymentSummary.repaymentMonths}개월간</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 총변제예정(유보)액</td>
            <td className="border border-black p-2 text-right pr-4 font-bold">{repaymentSummary.totalRepaymentAmount.toLocaleString()}원</td>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 변제예정액의 현재가치</td>
          ...
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 청산가치</td>
            <td className="border border-black p-2 text-right pr-4">{repaymentSummary.liquidationValue.toLocaleString()}원</td>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 면제재산 신청금액</td>
            <td className="border border-black p-2 text-right pr-4">0원</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 변제율</td>
            <td colSpan={3} className="border border-black p-2 text-left pl-4 font-bold text-indigo-900">
              원금의 [ {repaymentSummary.repaymentRatio} ] % 상당액
            </td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 변제형태</td>
            <td className="border border-black p-2">{repaymentSummary.repaymentType}</td>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 탕감예상 채무금액</td>
            <td className="border border-black p-2 text-right pr-4 text-emerald-800 font-bold">
              {Math.max(0, 46830000 - repaymentSummary.totalRepaymentAmount).toLocaleString()}원
            </td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-100 p-2 font-semibold">○ 기타</td>
...
export const PetitionCoverDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  ...
  return (
    <div className="court-page bg-white p-12 max-w-[210mm] mx-auto text-black font-serif border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 min-h-[297mm] flex flex-col justify-between">
      <div>
        {/* 상단 배지 */}
      ...
      <div className="flex justify-end pr-8 my-6">
        <div className="w-64 border-2 border-black text-[12px] text-center">
          <div className="grid grid-cols-2 border-b border-black">
            <div className="border-r border-black p-1 bg-slate-100">사 건 번 호</div>
            <div className="p-1 min-h-[24px]">{court.caseNumber}</div>
          </div>
          <div className="grid grid-cols-2 border-b border-black">
            <div className="border-r border-black p-1 bg-slate-100">해당순위번호</div>
            <div className="p-1"></div>
          </div>
          <div className="grid grid-cols-2 border-b border-black">
            <div className="border-r border-black p-1 bg-slate-100">재 판 부</div>
            <div className="p-1">제 부(단독)</div>
          </div>
          <div className="grid grid-cols-2 border-b border-black">
            <div className="border-r border-black p-1 bg-slate-100">주 심</div>
            <div className="p-1"></div>
          </div>
          <div className="grid grid-cols-2 border-b border-black">
            <div className="border-r border-black p-2 bg-slate-100">최초면담기일통지</div>
...
export const PetitionBodyDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  ...
  return (
    <div className="court-page bg-white p-12 max-w-[210mm] mx-auto text-black font-serif text-[12px] leading-relaxed border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-6">
      ...
      <table className="w-full border-collapse border border-black text-[11px]">
        <tbody>
          <tr>
            <td rowSpan={5} className="border border-black bg-slate-100 text-center font-bold w-16 p-2">신청인</td>
            <td className="border border-black bg-slate-50 p-1 w-20 text-center">성 명</td>
            <td className="border border-black p-1 font-bold">{debtor.name}</td>
            <td className="border border-black bg-slate-50 p-1 w-24 text-center">주민등록번호</td>
            <td className="border border-black p-1">{debtor.residentNumber}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">주민등록상<br />주 소</td>
            <td colSpan={3} className="border border-black p-1">{debtor.residentAddress}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">현 주 소</td>
            <td colSpan={3} className="border border-black p-1">{debtor.currentAddress}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">송 달 장 소</td>
            <td colSpan={3} className="border border-black p-1">{debtor.serviceAddress} (송달영수인: {lawyer.lawyerName})</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">휴대전화</td>
            <td colSpan={3} className="border border-black p-1">{debtor.phone}</td>
          </tr>
          <tr>
            <td rowSpan={4} className="border border-black bg-slate-100 text-center font-bold p-2">대리인</td>
            <td className="border border-black bg-slate-50 p-1 text-center">성 명</td>
            <td colSpan={3} className="border border-black p-1">{lawyer.firmName} {lawyer.lawyerName}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">사무실 주소</td>
            <td colSpan={3} className="border border-black p-1">{lawyer.address}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">전화번호</td>
            <td className="border border-black p-1">{lawyer.phone}</td>
            <td className="border border-black bg-slate-50 p-1 text-center">FAX번호</td>
            <td className="border border-black p-1">{lawyer.fax}</td>
          </tr>
          <tr>
            <td className="border border-black bg-slate-50 p-1 text-center">이메일</td>
      ...
      <div className="space-y-2 mt-4">
        ...
        <p className="indent-4 font-serif text-[13px] bg-slate-50 p-3 border border-slate-200">
...
export const CreditorListDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  ...
  return (
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[11px] leading-normal border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 text-[11px]">
        <table className="w-full border-collapse border border-black text-center">
          <tbody>
            <tr>
              <td rowSpan={3} className="border border-black bg-slate-100 font-bold p-1 w-20">채권현재액<br />합계</td>
              <td className="border border-black p-1 bg-slate-50 text-left pl-2">합계: {grandTotal.toLocaleString()} 원</td>
            </tr>
            <tr>
        ...
        <table className="w-full border-collapse border border-black text-center">
          <tbody>
            <tr>
              <td className="border border-black bg-slate-100 font-bold p-1">담보부 회생채권액 합계</td>
              <td className="border border-black p-1">0 원</td>
            </tr>
            <tr>
              <td className="border border-black bg-slate-100 font-bold p-1">무담보 회생채권액 합계</td>
          ...
          {creditors.map((c, idx) => (
            <tr key={c.id}>
              ...
              <td className="border border-black p-1 text-[10px]">
                ...
                <div className="text-slate-600">{c.creditorAddress} (전화: {c.creditorPhone || '고객센터'})</div>
                <div className="text-slate-500">이율: 연 {c.interestRate || 10}%</div>
              </td>
              ...
              <td className="border border-black p-1 text-right text-[10px]">
                ...
                <div className="text-slate-500 text-[9px]">{c.principalCalculationBasis || '부채증명서 참조'}</div>
              </td>
            </tr>
          ))}
        </tbody>
  ...
  return (
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[11px] leading-normal border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-4">
      <div className="text-center border-b border-black pb-2">
        ...
        <span className="text-[10px] text-slate-600">(단위 : 원)</span>
      </div>
      ...
      <table className="w-full border-collapse border border-black text-[11px]">
        ...
        <tbody>
          ...
          <tr className="bg-slate-100 font-bold">
            ...
            <td className="border border-black p-1 text-right pr-2 text-blue-900 font-bold">{repaymentSummary.liquidationValue.toLocaleString()}원</td>
            <td className="border border-black p-1 text-center">-</td>
    ...
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[11px] leading-normal border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-4">
      ...
      <div className="space-y-1">
        ...
        <table className="w-full border-collapse border border-black text-[11px]">
          <tbody>
            <tr>
              <td rowSpan={2} className="border border-black bg-slate-100 font-bold text-center w-20">수입상황</td>
              <td className="border border-black bg-slate-50 p-1 w-20 text-center">고용(직장명)</td>
              <td className="border border-black p-1">{debtor.workplaceName}</td>
              <td className="border border-black bg-slate-50 p-1 w-20 text-center">직 위</td>
              <td className="border border-black p-1">{debtor.jobTitle}</td>
            </tr>
            <tr>
              <td className="border border-black bg-slate-50 p-1 text-center">근무기간</td>
              <td colSpan={3} className="border border-black p-1">{debtor.tenureYearsMonths}</td>
            </tr>
            <tr>
              <td className="border border-black bg-slate-100 font-bold text-center">급 여</td>
              ...
              <td className="border border-black bg-slate-50 p-1 text-center">연간환산액</td>
  ...
  return (
    <div className="court-page bg-white p-8 max-w-[210mm] mx-auto text-black font-serif text-[10px] leading-normal border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-6 space-y-3">
      <div className="text-center border-b border-black pb-1">
        ...
        <span className="text-[9px] text-slate-500">(단위 : 원)</span>
      </div>
      ...
      <table className="w-full border-collapse border border-black text-center text-[9px]">
        ...
        <tbody>
          <tr>
            <td className="border border-black p-1 font-semibold bg-slate-50">기본급</td>
            {monthlyLedger.map((r, i) => (
          ...
          <tr>
            <td className="border border-black p-1 font-semibold bg-slate-50">상여금</td>
            {monthlyLedger.map((r, i) => (
          ...
          <tr className="bg-slate-100 font-bold">
            ...
            <td className="border border-black p-1 text-blue-900">{ledgerTotals.annualTotalIncome.toLocaleString()}</td>
          </tr>
          {/* 공제 항목 */}
          <tr>
            <td className="border border-black p-1 font-semibold bg-slate-50">소득세</td>
            {monthlyLedger.map((r, i) => (
          ...
          <tr>
            <td className="border border-black p-1 font-semibold bg-slate-50">4대보험 등</td>
            {monthlyLedger.map((r, i) => {
          ...
          <tr className="bg-slate-100 font-bold">
            ...
            <td className="border border-black p-1 text-red-900">{ledgerTotals.annualTotalDeductions.toLocaleString()}</td>
          </tr>
          <tr className="bg-emerald-50 font-bold">
            ...
            <td className="border border-black p-1 text-emerald-900">{ledgerTotals.annualNetIncome.toLocaleString()}</td>
          </tr>
        </tbody>
      </table>
      ...
      <table className="w-full border-collapse border border-black text-center text-[10px] mt-2 font-semibold">
        <tbody>
          ...
          <tr className="bg-slate-50">
            ...
            <td className="border border-black p-1 font-bold text-blue-900">{repaymentSummary.monthlyNetIncome.toLocaleString()}원</td>
            ...
            <td className="border border-black p-1 font-bold text-emerald-900">{repaymentSummary.monthlyDisposableIncome.toLocaleString()}원</td>
          </tr>
        </tbody>
      </table>
    </div>
...
export const WrittenStatementDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  ...
  return (
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[11px] leading-relaxed border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-4">
      <div className="text-center border-b border-black pb-2">
      ...
      <div className="space-y-1 pt-2">
        ...
        <div className="border border-slate-300 p-2 bg-slate-50 text-[10px] space-y-1">
    ...
    <div className="court-page bg-white p-12 max-w-[210mm] mx-auto text-black font-serif text-[12px] leading-relaxed border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-6">
      <div className="flex justify-between items-start">
        <div>
          ...
          <div className="text-[11px] text-slate-600">{debtor.residentAddress}</div>
        </div>
      ...
      <div className="space-y-2">
        ...
        <p className="indent-4 bg-slate-50 p-3 border border-slate-200 text-[12px]">
...
export const PowerOfAttorneyAndPledgeDoc: React.FC<DocTemplateProps> = ({ data, isEditable }) => {
  const { debtor, lawyer, court } = data;
  return (
    <div className="court-page bg-white p-10 max-w-[210mm] mx-auto text-black font-serif text-[11px] leading-relaxed border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-8 space-y-6">
      <div className="text-center border-b border-black pb-2">
      ...
      <div className="border border-black p-3 text-[11px] space-y-1 bg-slate-50">
